...
## Good to get in habit of calling factor() on the variable, as opposed to letting R decide as levels of (0,1,2) will be viewed as regressors where 2 will be treated as twice factor of 1
g1 = g
g1 = g1 + geom_abline(intercept = coef(fit)[1], slope = coef(fit)[2], size = 2)
...
Here, the (Intercept) value is the itc for mostly Protestant regions, with associated 
slope underneath. The factor(CatholicBin)1 value is to be added to the (Intercept)[beta0]
to find the itc of Catholic dominated regions. The slope for Catholic regions is the sum of the two slopes.
